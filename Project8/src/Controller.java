...
public class Controller {
	...
	public static void main(String[] args) {
		...
		LookupInterface li = new StudentLookup();
	...
	public static void timeTests(String file) {
		...
		System.out.println("Amount of words: " + wordList.size());

		// Average time for insert
		long startTime = System.nanoTime();
		StudentLookup tr = new StudentLookup();
...
//		System.out.println(tr.getWords().getSize());
